...
// import { loginFormControls } from '@/config'; // Reuse or create admin-specific controls if needed
...
//         console.log('Dispatched Admin Credentials:', response.admin);
...
//       </div>
//       <Form
//         formControls={loginFormControls} // You can customize this for admins if needed
...
//       if (response.success) {
//         dispatch(setAdminCredentials(response.admin));
//         console.log('Dispatched Demo Admin Credentials:', response.admin);
//         toast.success(response.message || 'Demo admin login successful');
//         // Navigation will be handled by useEffect
//       } else {
//         toast.error(response.message || 'Demo admin login failed');
