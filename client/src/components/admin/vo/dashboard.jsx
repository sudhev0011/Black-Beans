...
//   // RTK Query hooks
//   const queryParams = timeFilter === 'custom' 
//     ? { timeFilter, startDate: customDateRange.from, endDate: customDateRange.to }
//     : { timeFilter };

//   const { data: statistics, isLoading: statsLoading } = useGetStatisticsQuery(queryParams);
//   const { data: revenueData, isLoading: revenueLoading } = useGetRevenueDataQuery(queryParams);
//   const { data: categoryData, isLoading: categoryLoading } = useGetCategorySalesQuery(queryParams);
//   const { data: productData, isLoading: productLoading } = useGetBestSellingProductsQuery(queryParams);
//   const { data: orders, isLoading: ordersLoading } = useGetRecentOrdersQuery();
//   const { data: bestSellingCategory, isLoading: bestCategoryLoading } = useGetBestSellingCategoryQuery(queryParams);
