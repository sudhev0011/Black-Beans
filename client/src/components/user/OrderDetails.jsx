...
//   console.log("single order details from the component", order);
...
//       <Card>
//         <CardHeader>
//           <CardTitle className="text-lg font-medium text-primary">Order Items</CardTitle>
//         </CardHeader>
//         <CardContent>
...
//               return (
//                 <div key={`${item.productId?._id}-${item.variantId?._id || "no-variant"}`} className="flex items-center gap-4">
//                   <div className="h-16 w-16 rounded-md border bg-muted">
//                     <img src={item?.productId?.images[0] || "/placeholder.svg"} alt={item?.name} className="h-full w-full object-cover" />
//                   </div>
...
//                               <AlertDialogAction onClick={() => handleCancelItem(itemId)}>
//                                 Continue
//                               </AlertDialogAction>
//                             </AlertDialogFooter>
//                           </AlertDialogContent>
...
//             <p><strong>City:</strong> {order.shippingAddress.city}, {order.shippingAddress.state} {order.shippingAddress.postalCode}</p>
...
//         <CardContent>
//           <div className="space-y-2">
//             <p><strong>Payment Method:</strong> {order.paymentMethod.replace(/-/g, " ").toUpperCase()}</p>
//             <p><strong>Subtotal:</strong> ₹{order.subtotal.toFixed(2)}</p>
//             <p><strong>Shipping Cost:</strong> ₹{order.shipping.toFixed(2)}</p>
...
//       {/* Return Information for entire order */}
//       <Card>
//         <CardHeader>
//           <CardTitle className="text-lg font-medium text-primary">Order Return Information</CardTitle>
//         </CardHeader>
//         <CardContent>
...
//                 <Badge className={`capitalize ${getReturnStatusColor(order.returnRequest.status)}`}>
...
//                 <p><strong>Processed At:</strong> {new Date(order.returnRequest.processedAt).toLocaleString()}</p>
//               )}
//               {order.returnRequest.adminNotes && (
//                 <p><strong>Admin Notes:</strong> {order.returnRequest.adminNotes}</p>
//               )}
//             </div>
//           ) : order.status === "delivered" ? (
//             <div className="space-y-4">
//               <Input
//                 placeholder="Reason for returning entire order"
//                 value={returnReason}
//                 onChange={(e) => setReturnReason(e.target.value)}
//               />
//               {returnError && <p className="text-red-500 text-sm">{returnError}</p>}
//               <Button
//                 onClick={handleRequestReturn}
//                 disabled={!returnReason.trim() || isRequestingReturn}
//                 className="bg-primary hover:bg-primary/90"
//               >
//                 {isRequestingReturn ? "Submitting..." : "Request Return for Entire Order"}
//               </Button>
//             </div>
//           ) : (
//             <p className="text-muted-foreground">Returns are only available for delivered orders.</p>
//           )}
//         </CardContent>
//       </Card>
